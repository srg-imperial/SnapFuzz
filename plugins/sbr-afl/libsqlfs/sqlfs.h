...
int sqlfs_open_password(const char *db_file, const char *password,
                        sqlfs_t **sqlfs);
int sqlfs_change_password(const char *db_file_name, const char *old_password,
...
int sqlfs_open_key(const char *db_file, const uint8_t *key, size_t keylen,
                   sqlfs_t **psqlfs);
int sqlfs_rekey(const char *db_file_name, const uint8_t *old_key,
                size_t old_key_len, const void *new_key, size_t new_key_len);
#endif
#ifdef HAVE_LIBFUSE
