...
int sqlfs_del_tree_with_exclusion(sqlfs_t *sqlfs, const char *key,
...
int sqlfs_list_keys(sqlfs_t *, const char *pattern, void *buf,
...
int sqlfs_proc_create(sqlfs_t *sqlfs, const char *path, mode_t mode,
                      struct fuse_file_info *fi);
int sqlfs_proc_readlink(sqlfs_t *, const char *path, char *buf, size_t size);
int sqlfs_proc_readdir(sqlfs_t *, const char *path, void *buf,
...
int sqlfs_proc_read(sqlfs_t *, const char *path, char *buf, size_t size,
                    off_t offset, struct fuse_file_info *fi);
int sqlfs_proc_write(sqlfs_t *, const char *path, const char *buf, size_t size,
                     off_t offset, struct fuse_file_info *fi);
...
int sqlfs_proc_fsync(sqlfs_t *, const char *path, int isfdatasync,
                     struct fuse_file_info *fi);
int sqlfs_proc_setxattr(sqlfs_t *, const char *path, const char *name,
                        const char *value, size_t size, int flags);
int sqlfs_proc_getxattr(sqlfs_t *, const char path, const char *name,
